...
using dnTester.Lib.UnpackerTester;

namespace UnpackerTester.Console
{
    class Program
    {
        ...
        {
            System.Console.WriteLine("Welcome to Unpacker Tester!");
            ...
            catch (OptionException e)
            {
                ...
                System.Console.WriteLine("Try `UnpackerTester.Console.exe --help' for more information.");
                return;
            }
            ...
            if (filePath != null)
            {
                ...
                {
                    var ifSuccessfulPacked = dnTester.Lib.UnpackerTester.UnpackerTester.UnpackerTest(file);
